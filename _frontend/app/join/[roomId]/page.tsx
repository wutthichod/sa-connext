      ...
      if (participantsRes.ok) {
        ...
        if (participantsData.success && participantsData.data) {
          ...
          const mappedParticipants = users.map((u: any) => {
            ...
            console.log("[Join Event] Mapping user:", {
              raw: u,
              userId,
                            ...
                            <IconButton
                              ...
                              onClick={async () => {
                                try {
                                  ...
                                  console.log(
                                    "[Join Event] Starting chat with user:",
                                    recipientId
                                  );
                                  ...
                                  if (chatsRes.ok) {
                                    ...
                                    if (chatsData.success && chatsData.data) {
                                      ...
                                      if (existingChat) {
                                        console.log(
                                          "[Join Event] Found existing chat:",
                                  ...
                                  if (res.ok) {
                                    ...
                                    console.log(
                                      "[Join Event] Chat created successfully:",
                                      data
                                    );
                                    ...
                                    console.error(
                                      "[Join Event] Chat creation failed:",
                                      errorData
                                    );
                                    alert(
                                      errorData.error ||
                                  ...
                                  console.error(
                                    "[Join Event] Error creating chat:",
                                    err
                                  );
